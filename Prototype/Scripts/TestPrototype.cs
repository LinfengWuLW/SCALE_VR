    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.D) && (!isScaleAction))
        {
            ...
            else
            {
                ...
                //GameObject newSmallEntityPre = Resources.Load<GameObject>("S1_L");
                ...
                //GameObject newSmallEntity = Instantiate(newSmallEntityPre, this.transform.GetChild(numberOfVisableEntitiesHolder-1).GetChild(0).GetChild(0).position, Quaternion.identity);
        ...
        if (Input.GetKeyDown(KeyCode.U) && (!isScaleAction))
        {
            ...
            else
            {
                ...
                newLargeEntity.transform.parent = transform.GetChild(numberOfVisableEntitiesHolder - 1).GetChild(0).GetChild(5).transform;
        ...
        if (isScaleAction && ( !ani.IsPlaying("grow") && !ani.IsPlaying("shrink") ) )
        {
            ...
            if (shrink)
            {
                Destroy(transform.GetChild(numberOfVisableEntitiesHolder - 1).GetChild(0).GetChild(1).GetChild(0).gameObject);
                //GameObject.Destroy(gameObject);
